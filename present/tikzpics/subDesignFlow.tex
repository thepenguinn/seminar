\subtikzpicturedef{subDesignFlow} {
    ...
    \draw [very thick, gray, fill = bgcol] (#1-arrowEnd) circle [radius = 6pt];
    \draw [very thick, gray, fill = bgcol] (#1-arrowEnd) ++(12pt, 0) circle [radius = 3.5pt];
    ...
    (#1-legend) ++(0.5, 0)
    node [anchor = west] {\textsc{Design Flow Unique to TinyML}}
    ...
    (#1-legend) ++(0.5, 0)
    node [anchor = west] {\textsc{Design Flow Common to ML}}
    ;
