\subtikzpicturedef{subDesignFlow} {
    ...
    (#1-legend) ++(0.5, 0)
    node [anchor = west, absLabel] {\textsc{Model Compression Techniques}}
    ...
    (#1-legend) ++(0.5, 0)
    node [anchor = west, absLabel] {\textsc{Design Flow Unique to TinyML}}
    ;
    ...
    (#1-legend) ++(0.5, 0)
    node [anchor = west, absLabel] {\textsc{Design Flow Common with ML}}
    ;
