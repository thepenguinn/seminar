...
\newcommand\setcasestudy[0] {
    \titleformat{\chapter} [display]
    {\bfseries\normalfont\huge\filright\sffamily\vspace{-2cm}}
    {\Large\textsc{chapter \num[minimum-integer-digits = 2]{\thechapter} \hfill case study} \vspace{1em}}
    {1pc}
    {\titlerule\vspace{0.35em}\scshape}
    [\vspace{0.35em}{\titlerule[1pt]}]
}

\newcommand\unsetcasestudy[0] {
    \titleformat{\chapter} [display]
    {\bfseries\normalfont\huge\filright\sffamily\vspace{-2cm}}
...
\pagestyle{plain}
% \lhead{\textit{SOMETHING INTERESTING}}
% \rhead{}
